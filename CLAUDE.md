...
- `GamingStatusWidget.qml` - Main widget component (bar pill + popout)
- `GamingStatusSettings.qml` - Settings UI
- `GameDetector.js` - Game-process detection and gamemode status helpers
